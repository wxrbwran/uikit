...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "xr-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "xr-upload-list-item", key: item.uid },
